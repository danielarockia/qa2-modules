...
resource "aws_iam_policy" "eks-EKSLoadBalancerControllerpolicy" {
...
resource "aws_iam_role_policy_attachment" "EKSLoadBalancerControllerRoleatc" {
  policy_arn = aws_iam_policy.eks-EKSLoadBalancerControllerpolicy.arn
  role       = aws_iam_role.EKSLoadBalancerControllerRole.name
  depends_on = [
    aws_iam_policy.eks-EKSLoadBalancerControllerpolicy
  ]
}
